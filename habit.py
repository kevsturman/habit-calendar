...
habit = input("What habit do you want to track? (eg. Takeaways):")
image = input("What image do you want for the background in images/:")
if image == "":
    image = "veg.png"
...
d.text((50,50),habit,font=fntmed,fill=(0,0,0,255))
